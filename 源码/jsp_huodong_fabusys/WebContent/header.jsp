    ...
    <div class="container">
        <nav class="navbar navbar-default" role="navigation">
            <div class="navbar-header">
                ...
                <h1 class="navbar-brand"><a href="/index">活动报名平台</a></h1>
            </div>
            <!--navbar-header-->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle <c:if test="${param.flag==2}">active</c:if>" data-toggle="dropdown">活动分类<b class="caret"></b></a>
                    ...
                    <li><a href="/goodsrecommend_list?type=2" <c:if test="${param.flag==3 && t==2}">class="active"</c:if>>热门活动</a></li>
                    <li><a href="/goodsrecommend_list?type=3" <c:if test="${param.flag==3 && t==3}">class="active"</c:if>>新推活动</a></li>
                    ...
                    <c:choose><c:when test="${empty user }">
                        ...
                        <li><a href="/order_list" <c:if test="${param.flag==5 }">class="active"</c:if>>我的报名</a></li>
